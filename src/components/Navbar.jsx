...
function Navbar() {
  return (
   <nav class="flex max-h-[220px] max-w-full items-center justify-center backdrop-filter backdrop-blur-lg  absolute top-50 bottom-0 left-4  ">
  <div class="flex h-full w-16 items-center rounded-full bg-[#5F5F5F29]">
    <ul class=" flex h-95/100 w-full flex-col items-center justify-between ">
      <a href="#">
 <li class="bg-[#8C8C8C29] size-14 rounded-full  flex justify-center items-center">
          <svg class="max-w-[22px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="#">
        <li class=" size-14 rounded-full  flex justify-center items-center">
        <svg class="max-w-[22px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
