...
function Skill() {
  ...
  useGSAP(()=>{
    const array = gsap.utils.toArray(".skill-item");
  ...
  <div className="w-1000 h-32 bg-[#121212] -rotate-4  py-8">
    <div className="flex items-center justify-center h-full  space-x-4 will-change-transform skill-item cursor-pointer">
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Verbal Communication</p></span>
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Public Speaking</p></span>
      <span className="text-[#FFFFFF] font-bold text-2xl ml-2">lL</span>
      <span className="text-[#FFFFFF]">
       <svg className="size-8" viewBox="0 0 24 24" fill="none" >
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Teamwork</p></span>
      <span className="text-[#FFFFFF] font-bold text-2xl ml-2">lL</span>
      <span className="text-[#FFFFFF]">
       <svg className="size-8" viewBox="0 0 24 24" fill="none" >
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm text-nowrap">Collaboration</p></span>
      <span className="text-[#FFFFFF] font-bold text-2xl ml-2">lL</span>
      <span className="text-[#FFFFFF]">
       <svg className="size-8" viewBox="0 0 24 24" fill="none" >
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Critical Thinking</p></span>
      <span className="text-[#FFFFFF] font-bold text-2xl ml-2">lL</span>
      <span className="text-[#FFFFFF]">
       <svg className="size-8" viewBox="0 0 24 24" fill="none" >
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Creativity</p></span>
      <span className="text-[#FFFFFF] font-bold text-2xl ml-2">lL</span>
      <span className="text-[#FFFFFF]">
       <svg className="size-8" viewBox="0 0 24 24" fill="none" >
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Time Management</p></span>
      <span className="text-[#FFFFFF] font-bold text-2xl ml-2">lL</span>
      <span className="text-[#FFFFFF]">
       <svg className="size-8" viewBox="0 0 24 24" fill="none" >
      ...
      <span><p className="font-semibold text-[#6B6B6B] new-font-ibm">Work Ethic</p></span>
    </div>
  </div>
</section>
  )
